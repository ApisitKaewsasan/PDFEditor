...
public final class GeneratedPluginRegistrant {
  ...
  public static void registerWith(@NonNull FlutterEngine flutterEngine) {
    ...
    try {
      flutterEngine.getPlugins().add(new com.manaosoftware.pdfeditor.PdfeditorPlugin());
    } catch(Exception e) {
      Log.e(TAG, "Error registering plugin pdfeditor, com.manaosoftware.pdfeditor.PdfeditorPlugin", e);
    }
  }
}
